...
The results in this thesis show that task-graph information can support
...
evaluation is limited to a single-node benchmark suite. The most important
extensions concern broader evaluation, richer runtime models, stronger DVFS
objectives, lower-overhead instrumentation, and more systematic deployment
support.

\section{Broader Hardware and Workload Evaluation}
\label{sec:future-broader-evaluation}

A first extension is broader evaluation. The current results are from one
...
A final direction is reproducibility and deployment. Future versions should
