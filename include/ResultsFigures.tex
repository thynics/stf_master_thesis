...
\caption{Aggregate diagnostic overhead snapshot over the five reported benchmarks. Each bar reports the geometric-mean delta relative to the no-log Bandit baseline. The rows isolate compact placement logging, a force-noop WinDVFS path, and an all-HIGH WinDVFS path with no frequency requests.}
