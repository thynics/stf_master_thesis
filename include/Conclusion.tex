...
disabled, the bandit scheduler improves geometric-mean latency by \(9.99\%\)
...
\WinDVFS{} reduces geometric-mean energy by \(5.32\%\) with a geometric-mean
latency overhead of \(0.48\%\) under the fixed Bandit placement layer. The
geometric-mean EDP ratio improves to 0.951, and all five reported
...
The end-to-end result combines these effects: \BanditWinDVFS{} reduces
geometric-mean latency by \(8.80\%\), energy by \(11.87\%\), and EDP by
\(19.63\%\) relative to HEFT.
