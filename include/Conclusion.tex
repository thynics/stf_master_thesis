...
geometric-mean EDP ratio improves to 0.951354, and all five reported DVFS rows
remain below an EDP ratio of 1.0. The clock and power evidence shows that the
largest energy reductions are associated with lower average power and, in most
cases, lower active SM clock exposure.
