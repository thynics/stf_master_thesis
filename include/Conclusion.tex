...
\(7.146\%\) across six benchmarks using mean placement latencies. The behavior is
visible in the locality-attribution experiment: the largest improvements coincide
...
geometric-mean kernel-latency overhead of \(0.626\%\). The clock and power evidence
shows that the largest energy reductions are associated with lower kernel average
