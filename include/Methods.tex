...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.96\linewidth]{figures/methods_runtime_pipeline.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.86\linewidth]{figures/methods_residual_decision_flow.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.92\linewidth]{figures/methods_bandit_window_loop.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.94\linewidth]{figures/methods_dvfs_state_machine.pdf}
