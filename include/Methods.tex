...
\end{equation}
where the default weights are $0.35$, $0.20$, $0.15$, $0.20$, $0.10$, and $0.15$, respectively. This score is recorded only as a diagnostic quantity for evaluation; the actual proposal is governed by the threshold rules below.
