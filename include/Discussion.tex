...
power analysis shows that the larger energy reductions are associated with
lower average power and, in most cases, lower active SM clock exposure.
...
benchmark scale. The HEFT replay sanity check is less clean, so static replay
is treated as diagnostic evidence rather than as an exact zero-overhead
scheduler.
